...
gulp.task('rename', function () {
    let newname;
    let author = 'Moritz Heusinger';
    let email = 'moritz.heusinger@gmail.com';
    ...
    if (!newname) {
        console.log('Please write the new sonnen name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/sonnen.png')) {
        fs.renameSync(__dirname + '/admin/sonnen.png', __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/sonnen.html')) {
        fs.renameSync(__dirname + '/widgets/sonnen.html', __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/sonnen/js/sonnen.js')) {
        ...
        fs.renameSync(__dirname + '/widgets/sonnen/js/sonnen.js', __dirname + '/widgets/' + newname + '/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/sonnen')) {
        fs.renameSync(__dirname + '/widgets/sonnen', __dirname + '/widgets/' + newname);
    }
    const patterns = [
        {
            match: /sonnen/g,
        ...
        {
            match: /Sonnen/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Sonnen'
        },
        {
            match: /Moritz Heusinger/g,
            replacement: author
        },
        {
            match: /moritz.heusinger@gmail.com/g,
            replacement: email
        }
    ];
    const files = [
